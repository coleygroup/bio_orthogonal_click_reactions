...
parser.add_argument('--threshold-lower', type=int, default=22,
...
def select_dipoles(df_dipole_stat, threshold_lower=26):
...
if __name__ == '__main__':
    ...
    os.makedirs('bio_filter_final', exist_ok=True)
    ...
    df_strongly_endothermic =  df_pred[df_pred['predicted_reaction_energy'] > 3]
    df_pred = df_pred[df_pred['predicted_reaction_energy'] < 3]
    ...
    df_dipoles_selected = select_dipoles(df_dipole_stat, args.threshold_lower)
    
    df_dipoles_selected.to_csv('bio_filter_final/dipoles_above_threshold.csv')
