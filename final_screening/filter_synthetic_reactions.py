...
if __name__ == '__main__':
    ...
    filtered_reactions = get_final_filtered_rxn_smiles_synthetic(df_pred,
                                df_dipolarophiles_selected.values.tolist(), args.threshold_reverse_barrier, args.max_g_act)
    filtered_reactions[['rxn_id', 'rxn_smiles', 'predicted_activation_energy', 'predicted_reaction_energy', 'dipole']].to_csv('filtered_synthetic_reactions.csv')
    
    # print some summarizing statistics
    print(f'Number of selected reactions: {len(filtered_reactions)}')
    print(f'Number of unique dipoles selected: {len(filtered_reactions.dipole.unique())}')
    print(f'Number of unique dipolarophiles selected: {len(filtered_reactions.dipolarophile.unique())}')
